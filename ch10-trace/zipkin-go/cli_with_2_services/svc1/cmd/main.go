...
import (
	"fmt"
	"github.com/keets2012/Micro-Go-Pracrise/ch10-trace/zipkin-go/cli_with_2_services/svc1"
	"github.com/keets2012/Micro-Go-Pracrise/ch10-trace/zipkin-go/cli_with_2_services/svc2"
	"net/http"
	"os"
...
const (
	...
	zipkinHTTPEndpoint = "http://106.15.233.99:9411/api/v1/spans"
