...
func (s *StringServer) Concat(ctx context.Context, req *pb.StringRequest) (*pb.StringResponse, error) {
...
func (s *StringServer) Diff(ctx context.Context, req *pb.StringRequest) (*pb.StringResponse, error) {
