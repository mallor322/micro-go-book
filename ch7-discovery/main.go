...
import (
	...
	"flag"
	"fmt"
	"github.com/keets2012/Micro-Go-Pracrise/ch7-discovery/config"
	"github.com/keets2012/Micro-Go-Pracrise/ch7-discovery/discover"
	"github.com/keets2012/Micro-Go-Pracrise/ch7-discovery/endpoint"
	"github.com/keets2012/Micro-Go-Pracrise/ch7-discovery/service"
	"github.com/keets2012/Micro-Go-Pracrise/ch7-discovery/transport"
...
func main() {
	...
	var (
		...
		consulHost = flag.String("consul.host", "114.67.98.210", "consul host")
	)
