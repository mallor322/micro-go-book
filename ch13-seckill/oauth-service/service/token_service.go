...
type TokenGranter interface {
	grant(ctx context.Context, grantType string, client *ClientDetails) (*OAuth2Token, error)
}
...
func (tokenGranter *ComposeTokenGranter) grant(ctx context.Context, grantType string, client *ClientDetails) (*OAuth2Token, error) {
	...
	return dispatchGranter.grant(ctx, grantType, client)
}
