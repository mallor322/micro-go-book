...
func init() { proto.RegisterFile("string.proto", fileDescriptor_116e343673f7ffaf) }
...
func (*UnimplementedUserServiceServer) Calculate(ctx context.Context, req *UserRequest) (*UserResponse, error) {
