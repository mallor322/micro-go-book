...
//	}
//
//	nextOAuth2Token, err := jwtTokenEnhancer.sign(&oauth2Token, &OAuth2Details{
//		Client:&clientDetails,
//		User:&userDetails,
//	})
//
//	if err == nil{
//		//fmt.Println(nextOAuth2Token.TokenValue)
//	}else {
//		fmt.Println(err)
//	}
//
//	fmt.Println(*nextOAuth2Token)
//	fmt.Println(nextOAuth2Token.RefreshToken.TokenValue)
//
//	token, _ , _ := jwtTokenEnhancer.Extract(nextOAuth2Token.TokenValue)
//
//	fmt.Println(*token)
//	fmt.Println(token.RefreshToken.TokenValue)
//
//}
